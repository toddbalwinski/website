export default function Motif({ className = "" }: { className?: string }) {
  return (
    <div
      ...
      aria-hidden="true"
    >
      <div className="absolute -top-24 -right-24 h-72 w-72 rounded-full bg-slate-200/50 blur-3xl"></div>
      <div className="absolute -bottom-24 -left-16 h-80 w-80 rounded-full bg-teal-600/10 blur-3xl"></div>
